...
export default function BricksManagePage() {
  ...
  return (
    <SettingsShell title="Bricks Manage" className="bricks-manage-page">
            ...
            {paged.items.map((brick) => (
              ...
              >
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <span className="font-poppins truncate text-[32px] leading-[120%] font-semibold">{brick.name}</span>
                </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap items-center justify-center gap-3">
              <div className="brick-manage-preview inline-flex min-w-[180px] items-center justify-center gap-2 rounded-full px-5 py-2 text-white" style={{ backgroundColor: color }}>
                ...
                <span className="font-poppins text-[32px] leading-[120%] font-semibold">{previewLabel}</span>
              </div>
            </div>
